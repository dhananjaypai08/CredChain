...
const Home = (props) => {
  ...
  const connectWallet = async () => {
    const contractAddress = abi.address;//"0x8264a7B7d02ab5eF1e57d0ad10110686D79d8d46"//"0x681a204B065604B2b2611D0916Dca94b992f0B41"//"0x816df2a69bB2D246B1ee5a4F2d1B3EbcB3aF7C85";//"0x61eFE56495356973B350508f793A50B7529FF978"
  ...
  return (
    ...
    {verified!==undefined && <ul className="home-cards">
      ...
      <p className="caption">
          Your CredChain Profile:
      </p>
      <label className='home-button6 button'>Total CredChain Sharings allowed: {endorsementsAllowed}</label>
            ...
            <div className="home-main1">
              <div className="home-content02">
                <h2 className="home-header02">
                  CredChain: Decentralized Identity verification and storage system
                </h2>
